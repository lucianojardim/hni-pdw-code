...
namespace PDWDBContext
{
    public partial class PaoliPDWEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> spCanDeleteCompany(Nullable<int> companyId)
        {
            var companyIdParameter = companyId.HasValue ?
                new ObjectParameter("companyId", companyId) :
                new ObjectParameter("companyId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spCanDeleteCompany", companyIdParameter);
        }
    }
}
