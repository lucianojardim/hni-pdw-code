	...
	public class SpecRequestRepository : BaseRepository
	{
		...
		private SpecRequestInformation ToSpecRequestInformation( SpecRequest sInfo )
		{
			return new SpecRequestInformation()
			{
				...
				ProjectScope = sInfo.ProjectScope,
				ProjectedListPrice = sInfo.ProjectListPrice,
				IsPhasedProject = sInfo.IsPhasedProject ?? false,
				NumberOfPhases = sInfo.NumberOfPhases ?? 0,
				IsStandardsProgram = sInfo.IsStandardsProgram ?? false,
				FirstOrderDate = sInfo.ProjectFirstOrderDate,
				Competitors = sInfo.Competitors,
				CompetitorSeries = sInfo.CompetitorSeries,
				NeedFloorplanSpecs = sInfo.NeedFloorplanSpecs,
				NeedValueEng = sInfo.NeedValueEng,
		...
		public bool AddSpecRequest( SpecRequestInformation sInfo )
		{
			...
			newSpec.ProjectScope = sInfo.ProjectScope;
			newSpec.ProjectListPrice = sInfo.ProjectedListPrice;
			newSpec.IsPhasedProject = sInfo.IsPhasedProject;
			newSpec.NumberOfPhases = sInfo.IsPhasedProject ? sInfo.NumberOfPhases : (int?)null;
			newSpec.IsStandardsProgram = sInfo.IsStandardsProgram;
		...
		public bool UpdateSpecRequest( SpecRequestInformation sInfo )
		{
			...
			specInfo.ProjectScope = sInfo.ProjectScope;
			specInfo.ProjectListPrice = sInfo.ProjectedListPrice;
			specInfo.IsPhasedProject = sInfo.IsPhasedProject;
			specInfo.NumberOfPhases = sInfo.IsPhasedProject ? sInfo.NumberOfPhases : (int?)null;
			specInfo.IsStandardsProgram = sInfo.IsStandardsProgram;
			specInfo.ProjectFirstOrderDate = sInfo.FirstOrderDate;
			specInfo.Competitors = sInfo.Competitors;
			specInfo.CompetitorSeries = sInfo.CompetitorSeries;
